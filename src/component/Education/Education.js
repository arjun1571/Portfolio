...
const Education = () => {
  return (
    <div className="md:flex mt-10 ">
        ...
        <ul className="steps steps-vertical">
          ...
          >
            <div className="mt-5 border p-5 bg-slate-200 hover:bg-slate-400 rounded-lg">
              <h3 className="text-start text-2xl font-bold md:mx-5 mx-2">
                2010 - 2016
              </h3>
              <h3 className="text-start text-4xl font-bold md:p-5 p-2">
                High School
              </h3>
          ...
          >
            <div className="mt-5 border p-5 bg-slate-200 hover:bg-slate-400 rounded-lg">
              <h3 className="text-start text-2xl font-bold mx-2 md:mx-5">
                2017 - 2018
              </h3>
              <h3 className="text-start text-4xl font-bold md:p-5 p-2">
          ...
          >
            <div className="mt-5 border p-5 bg-slate-200 hover:bg-slate-400 rounded-lg">
              ...
              <h3 className="text-start text-4xl font-bold p-2 md:p-5 ">
                University
              </h3>
              <p className="text-start mx-2 md:mx-5 ">
      ...
      <div className="lg:w-1/2 ">
        <h3 className="text-center font-bold text-4xl">Experience</h3>
        <ul className="steps steps-vertical">
